...
const MatrixRainingCode = () => {
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      ctx.fillStyle = "#818cf8"; // Green color for characters
  ...
  return <canvas className="[mask-image:radial-gradient(ellipse_at_0%_0%,black_10%,var(--transparent)_70%)] fixed top-0 left-0" ref={canvasRef}></canvas>;
};
